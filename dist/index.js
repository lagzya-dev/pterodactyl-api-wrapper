...
async function ApplicationAPICall(options) {
  ...
  try {
    if (options.method === "PATCH") {
      const response = await import_axios.default.patch(url, options.body, { headers });
...
async function uploadFile(options) {
  return import_axios2.default.post(`${options.panel}/api/client/servers/${options.server_id}/files/upload`, options.file_data, {
    headers: {
      "Authorization": `Bearer ${options.apiKey}`,
